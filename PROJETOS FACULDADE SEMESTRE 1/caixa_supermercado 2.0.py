...
if senha == 2987:
    ...
    # Repetição para os numeros de clientes
    valortotal = 0
    ans = 'N'
    while ans == 'N':
        ...
        while n != 0:
            n = float(input(f"Digite o valor do item {cont}: R$"))
            # Desconsiderar o ultimo valor caso seja digitado -1
            if n == -1:
                valor -= valorantr
                n = float(input(f"Digite o valor correto do item {cont-1}: R$"))
                cont-=1
            # Finalizar a insesrção de valores quando inserido 0
            if n == 0:
                resp = input("Deseja Realmente Finalizar?? (S= Sim/N= Não)").upper()
                if resp == 'S':
                    print(f"Venda Finalizada com {cont-1} Itens\n")
                    break
                else:
                    n = float(input(f"Digite o valor do item {cont}: R$"))
            valor+=n
        ...
        # Realizar o troco e definir quantidade de cedulas
            ...
            if nduz < duz:
                ...
                while troco >= 200 and nduz < duz:
                    ...
                    i += 1   
                if nduz > 0:
                    print(f"{i} CÉDULA(s) DE 200".center(40))
            ...
            if ncem < cem:
                ...
                while troco >= 100 and ncem < cem:
                    ...
                    i += 1 
                if ncem > 0:
                    print(f"{i} CÉDULA(s) DE 100".center(40))
            ...
            if nciq < ciq:
                ...
                while troco >= 50 and nciq < ciq:
                    ...
                    i += 1 
                if nciq > 0:
                    print(f"{i} CÉDULA(s) DE 50".center(40))
            ...
            if ndez < dez:
                ...
                while troco >= 10 and ndez < dez:
                    ...
                    i += 1 
                if ndez > 0:
                    print(f"{i} CÉDULA(s) DE 10".center(40))
            ...
            if ncin < cin:
                ...
                while troco >= 5 and ncin < cin:
                    ...
                    i += 1 
                if ncin > 0:
                    print(f"{i} CÉDULA(s) DE 5 ".center(40))
            ...
            if num < um:
                ...
                while troco >= 1 and num < um:
                    ...
                    i += 1 
                if num > 0:
                    print(f"{i}  MOEDA(s) DE UM ".center(40))
